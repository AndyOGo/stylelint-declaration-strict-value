...
[stylelint-declaration-strict-value](../../README.md) / lib/validation

# lib/validation

## Functions

- [customExpected](functions/customExpected.md)
- [expected](functions/expected.md)
...
- [validOptions](functions/validOptions.md)
- [validProperties](functions/validProperties.md)
