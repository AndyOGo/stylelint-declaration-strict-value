[stylelint-declaration-strict-value - v1.10.11](../README.md) / [defaults](../modules/defaults.md) / IgnoreValueHash
...
[defaults.ts:38](https://github.com/AndyOGo/stylelint-declaration-strict-value/blob/04ca265/src/defaults.ts#L38)
